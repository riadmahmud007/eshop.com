...
<body>
	...
	<div class="categolis">
	<center><h2>Smartphone</h2></center>
 ...
 <center> <li><a href="#" class="w3-bar-item w3-button">Smartphone</a></li>
  ...
  <li><a href="watch.php" class="w3-bar-item w3-button">Watches</a></li>
   <li><a href="perfume.php" class="w3-bar-item w3-button">Perfume</a></li>
	...
	<div style=" float: left;font-size: 25px; margin: 0 auto; display: table; width: 80%;">
		<div>
		<?php 
			$getposts = mysql_query("SELECT * FROM products WHERE available >='1' AND item ='smartphone'  ORDER BY id DESC LIMIT 10") or die(mysql_error());
							...
							<ul style="float: left;">
								<li style="float: left; padding: 0px 25px 25px 25px;">
									<div class="home-prodlist-img"><a href="view_product.php?pid='.$id.'">
										<img src="../image/product/smartphone/'.$picture.'" class="home-prodlist-imgi">
										</a>
